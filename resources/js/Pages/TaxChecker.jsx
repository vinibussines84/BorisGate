    ...
    <AuthenticatedLayout>
      ...
      <div className="min-h-screen bg-[#0B0B0B] py-10 px-4 sm:px-6 lg:px-8 text-gray-100">
        <div className="max-w-7xl mx-auto space-y-10">
          {/* HEADER */}
          <div className="bg-[#0b0b0b]/90 border border-white/10 rounded-3xl p-6 flex items-center gap-5 shadow-lg backdrop-blur">
          ...
          {/* MOSTRA OS CARDS SOMENTE SE EXISTIR DADOS */}
          {stats?.total_bruto > 0 && (
            <>
              {/* CARDS FINANCEIROS */}
